...
export const translations = {
  ...
  eng: {
    ...
    articleP1: "America — A 9-year-old girl was found dead under suspicious circumstances at the Smith family residence in ${lokasi} on Saturday night (01/17/1924). The victim, identified as ${namaKorban} Smith. The incident occurred just hours before the family’s scheduled annual photo session on their front porch.",
...
articleP8: "The case remains under investigation. Police have stated that they will continue to follow every lead to uncover the truth behind the incident, which has since drawn widespread public attention.",
  ...
  id: {
    ...
    articleP1: "Jakarta, CNN Indonesia -- Seorang remaja perempuan berusia 9 tahun ditemukan tewas secara tidak wajar di kediaman keluarga Smith, tepatnya di ${lokasi}, Sabtu malam (17/01/1924). Korban diketahui bernama ${namaKorban} Smith. Insiden terjadi hanya beberapa jam sebelum keluarga tersebut dijadwalkan menjalani sesi foto tahunan mereka di teras rumah.",
